...
{
key: 'literature', icon: '📖', title: '文学经典', desc: '《小王子》法语原文，诗意与哲理',
tags: ['法→中', '文学'], srcLang: 'fr', tgtLang: 'zh',
...
{
key: 'scifi', icon: '🚀', title: '科幻巨著', desc: '《三体》经典片段，硬科幻风格',
tags: ['中→英', '叙事'], srcLang: 'zh', tgtLang: 'en',
...
{
key: 'techdoc', icon: '⚙️', title: '技术文档', desc: 'API 接口说明，术语密集',
tags: ['英→中', '技术'], srcLang: 'en', tgtLang: 'zh',
...
{
key: 'business', icon: '💼', title: '商务信函', desc: '正式邮件，礼貌用语与格式',
tags: ['英→中', '商务'], srcLang: 'en', tgtLang: 'zh',
text: `Dear Dr. Chen,
...
{
key: 'poetry', icon: '🏮', title: '古典诗词', desc: '唐诗宋词，意境深远',
tags: ['中→英', '文学'], srcLang: 'zh', tgtLang: 'en',
text: `静夜思
李白
...
{
key: 'philosophy', icon: '🏛️', title: '哲学思辨', desc: '尼采片段，抽象深邃',
tags: ['德→中', '哲学'], srcLang: 'de', tgtLang: 'zh',
...
{
key: 'multilang', icon: '🌐', title: '多语混杂', desc: '日韩英混排，测试语言检测',
tags: ['混合', '检测'], srcLang: 'ja', tgtLang: 'zh',
